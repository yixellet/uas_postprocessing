def catalogToArray(file, delimiter: str, structure, startWith: int):
...
if __name__ == '__main__':
    ar = catalogToArray('E:\\ГЕОДЕЗИЯ\\АЭРОФОТОСЪЕМКА\\Селитренное_2022\\010822\\avp1\\Селитренное_010822_центры_МСК30-1_1.txt', 
        ';', 
